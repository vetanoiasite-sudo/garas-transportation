...
[Keyless]
public partial class VPurchasePoSupplierAccountAmount
{
    [Column("ID")]
    ...
    public decimal? SupplierAccountAmount { get; set; }

    [StringLength(50)]
    public string SupplierAccountAmountAsign { get; set; }

    [Column("SupplierAccountSupplierID")]
    public long? SupplierAccountSupplierId { get; set; }

    [Column("SupplierAccountPurchasePOID")]
    public long? SupplierAccountPurchasePoid { get; set; }
}
